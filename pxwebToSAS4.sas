...
- output:
	1. Länmnar returkod till 0 om uppdatering genomförts och 1 om den inte genomfÃ¶rts.
***********************************/
proc ds2;
	package &prgLib..pxWebToSAS4 / overwrite=yes;
		...
		method pxwebtosas4();
			...
			vstring='pxwebToSAS version 4.0.0.B19_URF8';
		end;
******** getData varianter fär att göra det så flexibelt som möjligt att hämta data. start;
